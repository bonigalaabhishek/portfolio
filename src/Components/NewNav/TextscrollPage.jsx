...
const TextscrollPage = () => {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".1" className='w-full py-20 rounded-tl-3xl rounded-tr-3xl bg-green-950'>
        <div className="text gap-10 overflow-hidden border-t-2 border-b-2 border-zinc-300 flex whitespace-nowrap pr-20 ">
